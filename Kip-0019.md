...
**Note:** due to the nature of ranking this min, and sorting, implictly diversifies the metrics used. 
...
**Stage 2**
A Sybil / Spam attacker wishing to establish connections:
1. Will probablistically evict one of his own connections by weighting uptime,
2. Requires diverse Ip bucketing to not probablistically evict one of his own connections.
